...
def get_artist_objects(ax, no_of_vehicles):
    ...
    return vehicle_lines, trail_lines#, acc_lines, acc2_lines, velocity_lines, closest_points, turning_track_lines, speed_track_lines, \
...
def simulate(road_network, vehicles, obstacles, frames, parameters_list, file_name, with_road_network):  # reference track
    ...
    #     return vehicle_lines[0], trail_lines[0]#, acc_lines[0], acc2_lines[0], velocity_lines[0], trail_lines[0]
